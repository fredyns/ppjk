...
/**
 * This is the base-model class for table "daily_truckSupervising".
 *
 * @property integer $id
 ...
 */
abstract class DailyTruckSupervising extends \yii\db\ActiveRecord
{
