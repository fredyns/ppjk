...
/**
 * This is the base-model class for table "monthly_stuffingLocation".
 *
 * @property integer $id
 ...
 */
abstract class MonthlyStuffingLocation extends \yii\db\ActiveRecord
{
    ...
    {
        return 'monthly_stuffingLocation';
    }
