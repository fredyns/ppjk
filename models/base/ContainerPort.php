...
/**
 * This is the base-model class for table "containerPort".
 *
 * @property integer $id
 ...
 */
abstract class ContainerPort extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\ShippingInstruction::className(), ['destination_id' => 'id']);
    }
