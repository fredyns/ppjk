...
/**
 * ContainerPortSearch represents the model behind the search form about `app\models\ContainerPort`.
 */
class ContainerPortSearch extends ContainerPort
{
    /**
     * @inheritdoc
     */
