...
CREATE SCHEMA IF NOT EXISTS `ppjk` DEFAULT CHARACTER SET utf8 ;

CREATE TABLE IF NOT EXISTS `ppjk`.`migration` (
...
CREATE TABLE IF NOT EXISTS `ppjk`.`profile` (
...
CREATE TABLE IF NOT EXISTS `ppjk`.`social_account` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT(10) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ppjk`.`token` (
...
CREATE TABLE IF NOT EXISTS `ppjk`.`uploaded_file` (
...
CREATE TABLE IF NOT EXISTS `ppjk`.`user` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ppjk`.`yii_session` (
...
CREATE TABLE IF NOT EXISTS `ppjk`.`shippingInstruction` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ppjk`.`shipping` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ppjk`.`containerPort` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `ppjk`.`companyProfile` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ppjk`.`personel` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_personel_2`
    ...
    REFERENCES `ppjk`.`profile` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `ppjk`.`jobContainer` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ppjk`.`stuffingLocation` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `ppjk`.`truckSupervisor` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
