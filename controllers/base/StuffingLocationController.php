...
use app\models\search\StuffingLocationSearch;
use app\models\form\StuffingLocationForm;
use app\actioncontrols\StuffingLocationActControl;

/**
 * StuffingLocationController implements the CRUD actions for StuffingLocation model.
 */
class StuffingLocationController extends Controller
{
    ...
    /**
     * Lists all active StuffingLocation models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new StuffingLocationSearch;
        $dataProvider = $searchModel->searchIndex($_GET);
        $actionControl = StuffingLocationActControl::checkAccess('index', $searchModel);
    ...
    /**
     * Lists deleted active StuffingLocation models.
     * @return mixed
     */
    public function actionDeleted()
    {
        ...
        $actionControl = StuffingLocationActControl::checkAccess('deleted', $searchModel);
    ...
    /**
     * Displays a single StuffingLocation model.
     * @param integer $id
     *
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        $actionControl = StuffingLocationActControl::checkAccess('view', $model);
    ...
    /**
     * Creates a new StuffingLocation model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new StuffingLocationForm;
        $actionControl = StuffingLocationActControl::checkAccess('create', $model);
    ...
    /**
     * Updates an existing StuffingLocation model.
    ...
    /**
     * Deletes an existing StuffingLocation model.
    ...
    /**
     * Restores an deleted StuffingLocation model.
    ...
    /**
     * Finds the StuffingLocation model based on its primary key value.
