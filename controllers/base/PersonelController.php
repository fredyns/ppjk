...
use app\models\search\PersonelSearch;
use app\models\form\PersonelForm;
use app\actioncontrols\PersonelActControl;

/**
 * PersonelController implements the CRUD actions for Personel model.
 */
class PersonelController extends Controller
{
    ...
    /**
     * Lists all active Personel models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $actionControl = PersonelActControl::checkAccess('index', $searchModel);
    ...
    /**
     * Lists deleted active Personel models.
     * @return mixed
     */
    public function actionDeleted()
    {
        ...
        $actionControl = PersonelActControl::checkAccess('deleted', $searchModel);
    ...
    public function actionView($id)
    {
        ...
        $actionControl = PersonelActControl::checkAccess('view', $model);
    ...
    {
        $model = new PersonelForm;
        $actionControl = PersonelActControl::checkAccess('create', $model);
    ...
    /**
     * Restores an deleted Personel model.
