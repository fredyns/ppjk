...
use app\models\search\ContainerTypeSearch;
use app\models\form\ContainerTypeForm;
use app\actioncontrols\ContainerTypeActControl;
...
class ContainerTypeController extends Controller
{
    ...
    /**
     * Lists all active ContainerType models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $actionControl = ContainerTypeActControl::checkAccess('index', $searchModel);
    ...
    public function actionView($id)
    {
        ...
        $actionControl = ContainerTypeActControl::checkAccess('view', $model);
    ...
    {
        $model = new ContainerTypeForm;
        $actionControl = ContainerTypeActControl::checkAccess('create', $model);
    ...
    public function actionUpdate($id)
    {
        ...
        $actionControl = ContainerTypeActControl::checkAccess('update', $model);
    ...
    public function actionDelete($id)
    {
        try {
            ...
            ContainerTypeActControl::checkAccess('delete', $model);
    ...
    /**
     * Finds the ContainerType form model for modification.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ContainerTypeForm the loaded model
     * @throws HttpException if the model cannot be found
     */
    protected function findForm($id)
    {
        if (($model = ContainerTypeForm::findOne($id)) !== null) {
            return $model;
        } else {
            throw new HttpException(404, 'The requested page does not exist.');
        }
