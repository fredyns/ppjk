...
?>
<div class="giiant-crud shipping-view">
    ...
    <?php $this->beginBlock('app\models\Shipping'); ?>    
    <?=
    DetailView::widget([
        'model' => $model,
        'attributes' => [
    ...
    $addShippingInstruction = $ShippingInstructionActControl->button('create', [
        ...
        'urlOptions' => [
            'ShippingInstructionForm' => ['shipping_id' => $model->id],
        ],
    ]);
    ...
    Tabs::widget([
        ...
        'items' => [
            [
                ...
                'content' => $this->blocks['app\models\Shipping'],
                'active' => true,
            ],
            [
