    ...
    DetailView::widget([
        ...
        'attributes' => [
            [
                'attribute' => 'siNumber',
                'format' => 'html',
                'value' => '<b class="numbering">'.$model->siNumber.'</b>'
                .'&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ',
            ],
            [
    ...
    DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => ArrayHelper::getValue($model, 'driver.name', $model->driverName),
            ],
            [
                'attribute' => 'cellphone',
                'value' => ArrayHelper::getValue($model, 'driver.phone', $model->cellphone),
            ],
            'policenumber',
            'notes',
        ],
