...
Pjax::begin([
    'id' => 'pjax-TruckServices',
    'enableReplaceState' => false,
    'linkSelector' => '#pjax-TruckServices ul.pagination a, th a',
    'clientOptions' => [
...
$addJobContainer = $JobContainerActControl->button('create',
    ...
    'label' => 'New Trucking',
    'urlOptions' => [
        'JobContainerForm' => ['truckVendor_id' => $model->id],
    ],
    ]);
...
echo GridView::widget([
    ...
    'dataProvider' => new \yii\data\ActiveDataProvider([
        'query' => $model->getTruckServices(),
        'pagination' => [
            'pageSize' => 50,
            'pageParam' => 'page-truckservices',
        ],
        'sort' => [
            'defaultOrder' => [
                'id' => SORT_DESC,
