...
/**
 * MonthlyDriving model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property MonthlyDriving $model data model
 */
class MonthlyDrivingActControl extends \fredyns\suite\libraries\ActionControl
{
