...
/**
 * MonthlyTruckSupervising model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property MonthlyTruckSupervising $model data model
 */
class MonthlyTruckSupervisingActControl extends \fredyns\suite\libraries\ActionControl
{
    ...
    {
        return '/monthly-truck-supervising';
    }
