...
/**
 * Shipping model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property Shipping $model data model
 */
class ShippingActControl extends \fredyns\suite\libraries\ActionControl
{
    ...
    public function messages()
    {
        return [
            ...
            // additions
            'hassi' => "This shipping had shipping instruction history.",
        ];
    }
