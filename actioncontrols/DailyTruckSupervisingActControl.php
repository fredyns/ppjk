...
/**
 * DailyTruckSupervising model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property DailyTruckSupervising $model data model
 */
class DailyTruckSupervisingActControl extends \fredyns\suite\libraries\ActionControl
{
    ...
    {
        return '/daily-truck-supervising';
    }
