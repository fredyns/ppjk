...
/**
 * MonthlyShipper model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property MonthlyShipper $model data model
 */
class MonthlyShipperActControl extends \fredyns\suite\libraries\ActionControl
{
