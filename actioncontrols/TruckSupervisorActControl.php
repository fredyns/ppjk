...
/**
 * TruckSupervisor model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property TruckSupervisor $model data model
 */
class TruckSupervisorActControl extends \fredyns\suite\libraries\ActionControl
{
    ...
    public function messages()
    {
        return [
            ...
            // additions
            'hascontainer' => "Mandor ini memiliki riwayat penugasan.",
        ];
    }
