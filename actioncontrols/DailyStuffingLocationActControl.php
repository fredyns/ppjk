...
/**
 * DailyStuffingLocation model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property DailyStuffingLocation $model data model
 */
class DailyStuffingLocationActControl extends \fredyns\suite\libraries\ActionControl
{
    ...
    {
        return '/daily-stuffing-location';
    }
