...
/**
 * MonthlyStuffingLocation model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property MonthlyStuffingLocation $model data model
 */
class MonthlyStuffingLocationActControl extends \fredyns\suite\libraries\ActionControl
{
    ...
    {
        return '/monthly-stuffing-location';
    }
