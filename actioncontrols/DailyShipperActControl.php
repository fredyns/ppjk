...
/**
 * DailyShipper model action control
 *
 * @author Fredy Nurman Saleh <email@fredyns.net>
 *
 * @property DailyShipper $model data model
 */
class DailyShipperActControl extends \fredyns\suite\libraries\ActionControl
{
